...
void SPI2_Inits(void){
	...
	SPI2_Handle.Spi_Config.SPI_SclkSpeed=SPI_CLK_SPE_DIV_2;// Generate 8MH Clock
	...
	SPI2_Handle.Spi_Config.SPI_SSM=SPI_SSM_EN; // Software slave management for NSS pin
...
int main(void){
	...
	/*
		 ...
		 * this is required when we use SSM(software slave management)
		 */
	SPI_SSI_CONFIG(SPI2, ENABLE );
	/*
	 *  Enable the SPI2 Peripheral after all the setup done
